...
[Insert your calculation of the $3 \times 3$ matrix $\mathbf{M}_{\text{reflect}}(\vec{a})$ here]

### 2. Plane Reflection Calculation
[Insert your vector multiplication $\vec{v}'_{\text{plane}} = \mathbf{M}_{\text{reflect}}(\vec{a})\vec{v}$ here]

### 3. Axis Reflection Matrix
[Insert your calculation of the $3 \times 3$ matrix $\mathbf{M}_{\text{invol}}(\vec{a})$ here]

### 4. Axis Reflection Calculation
[Insert your vector multiplication $\vec{v}'_{\text{axis}} = \mathbf{M}_{\text{invol}}(\vec{a})\vec{v}$ here]
